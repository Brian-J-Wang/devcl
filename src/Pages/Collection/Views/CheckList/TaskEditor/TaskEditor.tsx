...
type TaskEditorProps = {
	...
	editorController: Omit<ReturnType<typeof useEditorController>, "value">;
};

const TaskEditor: React.FC<TaskEditorProps> = ({ editorController }) => {
	const [task, setTask] = useState<Task>(editorController.currentTask);

	useEffect(() => {
		setTask(editorController.currentTask);
	}, [editorController.currentTask]);
